...
const GoogleLogo: React.FC = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" style={{ margin: 0 }}>
...
const AppleLogo: React.FC = () => (
  <svg width="18" height="18" viewBox="0 0 814 1000" xmlns="http://www.w3.org/2000/svg" style={{ margin: 0 }}>
...
const GitHubLogo: React.FC = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ margin: 0 }}>
...
const MicrosoftLogo: React.FC = () => (
  <svg width="18" height="18" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg" style={{ margin: 0 }}>
...
const FirebaseAuthButtons: React.FC<Props> = ({
  onGoogleSignIn, onAppleSignIn, onGitHubSignIn, onMicrosoftSignIn, loading, error
}) => {
  // Icon-only square buttons sized to fit 4 across with spacing
  const buttonStyle = {
    minWidth: 52,
    width: 52,
    height: 52,
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      {/* Icon buttons — centered row, sized for up to 4 providers */}
      <div style={{ display: 'flex', justifyContent: 'center', gap: 12 }}>
        ...
        <Button
          ...
          style={{ ...buttonStyle, borderColor: '#dadce0', color: '#3c4043' }}
          title='Continue with Google'
        >
          {loading ? <CircularProgress size={18} /> : <GoogleLogo />}
        </Button>
        ...
        {APPLE_ENABLED && (
          <Button
            ...
            style={{ ...buttonStyle, borderColor: '#000', color: '#000' }}
        ...
        {GITHUB_ENABLED && (
          <Button
            ...
            style={{ ...buttonStyle, borderColor: '#24292e', color: '#24292e' }}
        ...
        {MICROSOFT_ENABLED && (
          <Button
            ...
            style={{ ...buttonStyle, borderColor: '#00a4ef', color: '#00a4ef' }}
      ...
      {error && (
        <Typography variant='caption' color='error' style={{ display: 'block', marginTop: 8, textAlign: 'center' }}>
          {error}
        </Typography>
      )}
    </div>
